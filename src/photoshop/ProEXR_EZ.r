...
#define plugInSuiteID		'EXRz'
#define plugInClassID		'zEXR'
...
{
    {
		...
		Priority { ProEXR_EZ_Priority }, // can be used to decide if ProEXR or ProEXR EZ go first

...
@implementation ProEXR_In_Controller
...
- (id)init:(ProEXR_In_Prefs *)prefs {
	...
	if(!([NSBundle loadNibNamed:@"ProEXR_In" owner:self]))
		return nil;
	...
	[ignoreLayeringCheck setState:([prefs getIgnoreLayerText] ? NSOnState : NSOffState)];
...
- (IBAction)clickedOK:(id)sender {
	...
	[prefs_obj setIgnoreLayerText:([ignoreLayeringCheck state] == NSOnState)];

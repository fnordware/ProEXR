...
#include "ProEXR_About_Controller.h"

#include "ProEXR_Version.h"


#ifdef PRO_EXR_EZ
#define BUNDLE_ID "com.fnordware.Photoshop.ProEXR_EZ"
#else
#define BUNDLE_ID "com.fnordware.Photoshop.ProEXR"
#endif
...
void ProEXR_About(void)
{
	Class about_controller_class = [[NSBundle bundleWithIdentifier:@BUNDLE_ID]
									classNamed:@"ProEXR_About_Controller"];
	
	if(about_controller_class)
	{
		ProEXR_About_Controller *about_controller = [[about_controller_class alloc]

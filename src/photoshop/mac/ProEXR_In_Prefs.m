...
@implementation ProEXR_In_Prefs
...
- (void)setIgnoreLayerText:(BOOL)ignoreLayerText {
	ignore_layertext = ignoreLayerText;
}
...
- (void)readPrefs {
	...
	if(ignoreLayerText)
	{
		ignore_layertext = CFBooleanGetValue((CFBooleanRef)ignoreLayerText);
...
- (void)writePrefs {
	...
	CFBooleanRef ignoreLayerText = ignore_layertext ? kCFBooleanTrue : kCFBooleanFalse;
